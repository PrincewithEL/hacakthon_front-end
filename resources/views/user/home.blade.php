...
<head>
  ...
  <title>SME Inventory Management - User Page</title>
  <!-- plugins:css -->
...
<!--           <li class="nav-item d-none d-lg-flex">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="{{ route('profile') }}" data-toggle="dropdown" id="profileDropdown">
              <img src="user_images/{{ $userdetails->profile_photo_path }}" alt="profile"/>
            </a>
...
<!--           <div class="row grid-margin">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Provide Details for Analysis</h4>
<!--                   <p class="card-description">
                    Basic form layout
                  </p> -->
                  <form class="cmxform" id="commentForm" enctype="multipart/form-data" method="post" action="{{ url('save_csv') }}">
                        @csrf
                    <fieldset>
                                  <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Input A CSV File:</h4>
                  <input type="file" class="dropify" accept=".csv, .xls" required name="csv" />
                </div>
              </div>
            </div>
                      <div class="form-group">
                        <label for="ccomment">Your Description (if any)</label>
